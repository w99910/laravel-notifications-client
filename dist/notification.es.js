...
const $ = new ue(
  ...
  setup(g, { emit: r }) {
    const o = g, s = (n) => o.locales[n] || n, v = r, d = k(!1), f = k(!1), y = k("unread"), a = k(!1), _ = k(null), w = k(Date.now()), p = k(!1), C = k(null), N = k(null), m = k([]), S = E(
...
}, Ze = /* @__PURE__ */ U(Ue, [["__scopeId", "data-v-b7fd5f21"]]), Fe = { class: "confirmation-content" }, He = { class: "confirmation-title" }, Je = { class: "confirmation-message" }, Xe = { class: "confirmation-actions" }, We = ["disabled"], Ye = {
  key: 0,

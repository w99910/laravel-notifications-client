...
const C = new le(
...
}, ue = { class: "flex items-center" }, ce = { class: "flex items-center space-x-4" }, de = ["onClick"], ge = {
  key: 0,
  class: "ml-2 bg-blue-500 text-white text-xs rounded-full px-2 py-1"
}, ve = {
  key: 1,
  class: "p-6 text-center"
}, fe = { class: "text-red-500 mb-2" }, he = { class: "mb-2" }, ye = {
  key: 1,
  class: "mt-4"
}, pe = { key: 3 }, be = { class: "w-10 h-10 mr-3 flex-shrink-0 flex items-center justify-center" }, me = ["src", "alt"], xe = {
  key: 0,
  "fill-rule": "evenodd",
  ...
  d: "M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z",
  "clip-rule": "evenodd"
}, Ne = { class: "flex-1 min-w-0" }, Ae = { class: "flex items-center justify-between" }, Me = { class: "flex items-center space-x-2" }, Se = { class: "relative group" }, $e = ["onClick"], Ie = ["onClick"], Te = ["onClick"], Be = {
  key: 0,
  class: "w-2 h-2 bg-blue-500 rounded-full"
}, Ee = {
  key: 0,
  class: "mt-2"
}, Le = { class: "flex items-center justify-between mb-1" }, Oe = {
  key: 1,
  class: "flex flex-wrap gap-2 mt-3"
}, ze = ["href", "onClick"], Pe = { class: "flex items-center" }, qe = {
  __name: "notification",
  props: {
    notifications: {
      type: Array,
  ...
  setup(h, { emit: t }) {
    const u = h, v = t, d = x(!1), c = x(!1), y = x("inbox"), r = x(!1), k = x(null), _ = x(Date.now()), m = x(!1), w = x(null), N = x(null), f = x([]), A = B(
      () => f.value.filter((o) => !o.read_at).length
    ), O = B(() => y.value === "unread" ? f.value.filter((o) => !o.read_at) : y.value === "read" ? f.value.filter((o) => o.read_at) : f.value), D = B(() => [
      {
        id: "inbox",
        name: "All",
        count: 0
      ...
      v("action-clicked", { action: o, notification: s }), s.read_at || await P(s.id), (o.label.toLowerCase() === "accept" || o.label.toLowerCase() === "decline") && await q(s.id), o.url && o.url !== "#" && (window.location.href = o.url);
    }, W = (o) => {
    ...
    let T = null;
    return Y(async () => {
      const o = await C.getUserId();
      if (!o) {
        console.error("User ID not found. Please ensure the user is authenticated.");
        return;
      }
      if (document.addEventListener("click", R), window.matchMedia && window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change", (e) => {
      ...
      console.log("Setting up Echo channel listener...", u.user_id || o || 1);
      const s = Echo.private("App.Models.User." + (u.user_id || o || 1));
      s.subscribed(() => {
        ...
        const g = f.value.find((S) => S.id === e.id);
        ...
        if (e && e.progress < 100) {
          ...
          const S = setInterval(() => {
            ...
            ], clearInterval(S)) : e.progress = Math.floor(g);
          }, 2e3);
        }
      }, 3e3);
    }), K(() => {
      if (document.removeEventListener("click", R), window.matchMedia && window.matchMedia("(prefers-color-scheme: dark)").removeEventListener("change", () => {
      }), T && clearInterval(T), window.Echo) {
      ...
      a("button", {
        ...
        A.value > 0 ? (n(), l("span", ie, p(A.value > 99 ? "99+" : A.value), 1)) : b("", !0)
      ], 2),
      G(Q, {
        ...
        default: Z(() => [
          d.value ? (n(), l("div", {
            ...
            a("div", {
              ...
              (n(!0), l(E, null, L(D.value, (e) => (n(), l("button", {
                key: e.id,
                ...
                V(p(e.name) + " ", 1),
                e.count > 0 ? (n(), l("span", ge, p(e.count), 1)) : b("", !0)
              ], 10, de))), 128))
            ], 2),
            a("div", {
              ...
              m.value ? (n(), l("div", {
                ...
                V(" Loading notifications... ")
              ]), 2)) : w.value ? (n(), l("div", ve, [
                a("div", fe, p(w.value), 1),
                a("button", {
                  onClick: J,
                ...
                a("div", he, p(y.value === "unread" ? "No unread notifications" : y.value === "read" ? "No read notifications" : f.value.length === 0 ? "No notifications yet" : "No notifications"), 1),
                y.value !== "inbox" && f.value.length > 0 ? (n(), l("button", {
                  key: 0,
                  onClick: s[0] || (s[0] = (e) => y.value = "inbox"),
                  class: "text-sm text-blue-500 hover:text-blue-600"
                }, " View all notifications ")) : f.value.length === 0 ? (n(), l("div", ye, [
                  (n(), l("svg", {
                ...
                (n(!0), l(E, null, L(O.value, (e) => (n(), l("div", {
                  key: e.id,
                  ...
                  a("div", be, [
                    e.avatar ? (n(), l("img", {
                      ...
                      key: 1,
                      class: i(["w-10 h-10 rounded-full flex items-center justify-center", I(te)(e.status, r.value)])
                    }, [
                      (n(), l("svg", {
                        class: i(["w-5 h-5", I(re)(e.status, r.value)]),
                        fill: "currentColor",
                        viewBox: "0 0 20 20"
                      }, [
                        e.status === "info" ? (n(), l("path", xe)) : e.status === "success" ? (n(), l("path", we)) : e.status === "warning" ? (n(), l("path", ke)) : e.status === "error" ? (n(), l("path", _e)) : (n(), l("path", Ce))
                      ], 2))
                    ], 2))
                  ]),
                  a("div", Ne, [
                    a("div", Ae, [
                      ...
                      a("div", Me, [
                        ...
                        e.read_at ? b("", !0) : (n(), l("div", Be))
                      ])
                    ]),
                    a("p", {
                      class: i(["text-sm mt-1", r.value ? "text-gray-300" : "text-gray-600"])
                    }, p(e.message), 3),
                    e.progress !== void 0 && e.progress !== null ? (n(), l("div", Ee, [
                      a("div", Le, [
                        a("span", {
                          class: i(["text-xs", r.value ? "text-gray-400" : "text-gray-500"])
                        }, "Progress", 2),
                      ...
                      a("div", {
                        ...
                        a("div", {
                          ...
                          style: j({ width: `${e.progress}%` })
                        }, null, 6)
                      ], 2)
                    ])) : b("", !0),
                    e.actions ? (n(), l("div", Oe, [
                      (n(!0), l(E, null, L(e.actions, (g) => (n(), l("a", {
                        key: g.label,
                        href: g.url,
                        onClick: $((S) => X(g, e), ["prevent"]),
                        class: "px-3 py-1 text-xs font-medium rounded transition-colors",
                        style: j({
                          backgroundColor: g.backgroundColor || "#f3f4f6",
                          color: I(ae)(g.backgroundColor)
                        })
                      }, p(g.label), 13, ze))), 128))
                    ])) : b("", !0),
...
}, Ve = /* @__PURE__ */ ne(qe, [["__scopeId", "data-v-c8d6cb61"]]);
export {
  Ve as default
};

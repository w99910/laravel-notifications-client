...
const C = new ne(
  ...
  d: "M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z",
  "clip-rule": "evenodd"
}, $e = { class: "flex-1 min-w-0" }, Me = { class: "flex items-center justify-between" }, Ie = { class: "flex items-center space-x-2" }, Te = { class: "relative group" }, Ee = ["onClick"], Be = ["onClick"], Le = ["onClick"], Oe = {
  key: 0,
...
}, je = ["onClick"], qe = { class: "flex items-center" }, Ve = {
  __name: "notification",
  props: {
    notifications: {
      type: Array,
  ...
  setup(f, { emit: t }) {
    const c = f, l = (a) => c.locales[a] || a, y = t, d = x(!1), h = x(!1), p = x("inbox"), s = x(!1), k = x(null), N = x(Date.now()), _ = x(!1), w = x(null), A = x(null), v = x([]), S = B(
    ...
    ), z = B(() => p.value === "unread" ? v.value.filter((a) => !a.read_at) : p.value === "read" ? v.value.filter((a) => a.read_at) : v.value), D = B(() => [
      {
        id: "inbox",
        name: "All",
        count: 0
      ...
      if (y("action-clicked", { action: a, notification: o }), o.read_at || await T(o.id), (a.label.toLowerCase() === l("accept") || a.label.toLowerCase() === l("decline")) && await R(o.id), a.url && a.url !== "#") {
        const e = document.createElement("a");
        e.href = a.url, e.target = "_blank", e.rel = "noopener noreferrer", document.body.appendChild(e), e.click(), document.body.removeChild(e);
      }
    }, W = (a) => {
                ...
                (i(!0), n(L, null, O(z.value, (e) => (i(), n("div", {
                  ...
                  r("div", $e, [
                    ...
                    e.actions ? (i(), n("div", Re, [
                      (i(!0), n(L, null, O(e.actions, (b) => (i(), n("button", {
                        key: b.label,
                        onClick: M((q) => X(b, e), ["stop"]),
...
}, Ue = /* @__PURE__ */ ie(Ve, [["__scopeId", "data-v-3b78a8b1"]]);
export {
  Ue as default
};
